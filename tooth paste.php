...
<center>     <div id="section" style="word-spacing: 50px;font-size: x-large">
             <center><H1 STYLE="font-size: 50px"><u>TOOTH-PASTE</u></H1></center>
    <br><br>

         <b style="margin-left: 90px;">COLGATE</b>  <br><br>
         <img src="image/colgate.jpeg" width="300" height="300" alt="colgate"/><br><br>
    <form  action="cart_entry.php" method="post">
 price:45
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="59" size="1" readonly />
 </form>

 <br><br>------------------------------------------------------------------------------------<br><br>
         
          <b style="margin-left: 90px">PEPSODENT</b>  <br><br>
          <img src="image/pepsodent-toothpaste-product-review-bd1.jpg" width="300" height="300" alt="pepsodent"/><br><br>
    <form  action="cart_entry.php" method="post">
 price:45
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="61" size="1" readonly />
 </form>
 <br><br>------------------------------------------------------------------------------------<br><br>
  <b style="margin-left: 90px">CLOSE-UP</b><br><br>
  <img src="image/close up.jpg" width="300" height="140" alt="close-up"/><br><br>
   <form  action="cart_entry.php" method="post"> 
 price:85
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="60" size="1" readonly />
 </form>
<br><br>------------------------------------------------------------------------------------<br><br>
   <b style="margin-left: 90px">SENSODYNE</b><br><br>
   <img src="image/sensodyne.jpg" width="300" height="300" alt="synsodyne"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:160
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="62" size="1" readonly />
 </form>
