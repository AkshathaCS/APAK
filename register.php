...
<html>
    ...
    <body style="background-color: white; background-image: url(image/8tXOOTr.jpg) ">
    ...
    <center style="font-size: 50pt;<!--font-family : AR BONNIE-->">CREATE AN ACCOUNT</center><br>
    <div>
        
        <box>
        <form  action="enter_action.php" method="post">
 <center>
    <table>
    <tr>
    <td>Name:</td>
    ...
    <tr>
    <td>Phone:</td>
    <td><input type="number" name="user_phone" required><br></td>
    </tr>
    <tr>
    <td>Street:</td>
