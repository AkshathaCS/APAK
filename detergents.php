...
<center>     <div id="section" style="word-spacing: 50px;font-size: x-large">
             <center><H1 STYLE="font-size: 50px"><u>DETERGENTS</u></H1></center>
    <br><br>

         <b style="margin-left: 90px;">TIDE</b>  <br><br>
         <img src="image/tide.jpg" width="300" height="400" alt="tide"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:90
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="38" size="1" readonly />
 </form>

 <br><br>------------------------------------------------------------------------------------<br><br>
         
          <b style="margin-left: 90px">RIN</b>  <br><br>
          <img src="image/Rin.jpg" width="300" height="400" alt="rin"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:75
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="36" size="1" readonly />
 </form>
 <br><br>------------------------------------------------------------------------------------<br><br>
  <b style="margin-left: 90px">SURF-EXCEL</b> <br><br>
  <img src="image/surf excel.png" width="300" height="400" alt="surf-excel"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:150
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="37" size="1" readonly />
 </form>
<br><br>------------------------------------------------------------------------------------<br><br>
   <b style="margin-left: 90px">HENKO</b><br><br>
   <img src="image/henko.jpeg" width="300" height="400" alt="henko"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:130
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="35" size="1" readonly />
 </form>
