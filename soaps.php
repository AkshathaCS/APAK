...
<center>     <div id="section" style="word-spacing: 50px;font-size: x-large">
             <center><H1 STYLE="font-size: 50px"><u>SOAPS</u></H1></center>
    <br><br>

         <b style="margin-left: 90px;">DOVE</b>  <br><br>
         <img src="image/Dove.png" width="300" height="300" alt="dove"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:45
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="51" size="1" readonly />
 </form>

 <br><br>------------------------------------------------------------------------------------<br><br>
         
          <b style="margin-left: 90px">PEARS</b>  <br><br>
          <img src="image/Pears-.jpg" width="300" height="300" alt="pears"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:58
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="54" size="1" readonly />
 </form>
 <br><br>------------------------------------------------------------------------------------<br><br>
  <b style="margin-left: 90px">JOHNSON'S-BABY</b> <br><br>
  <img src="image/johnson.jpg" width="300" height="300" alt="johnson-baby"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:72
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="53" size="1" readonly />
 </form>
<br><br>------------------------------------------------------------------------------------<br><br>
   <b style="margin-left: 90px">HAMAM</b><br><br>
   <img src="image/Hamam.jpg" width="300" height="300" alt="hamam"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:27
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="52" size="1" readonly />
 </form>
 </div></center>
