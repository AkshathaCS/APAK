...
<html>
    <head>
        ...
        <title>ApAk-KitchenCleaners</title>
        <meta charset="UTF-8">
...
<center>     <div id="section" style="word-spacing: 50px;font-size: x-large">
             <center><H1 STYLE="font-size: 50px"><u>KITCHEN-CLEANERS</u></H1></center>
    <br><br>

         <b style="margin-left: 90px;">SABENA</b>  <br><br>
         <img src="image/sabena.jpg" width="300" height="400" alt="sabena"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:20
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="45" size="1" readonly />
 </form>
 <br><br>------------------------------------------------------------------------------------<br><br>
         
          <b style="margin-left: 90px">VIM</b>  <br><br>
          <img src="image/vim.jpg" width="300" height="400" alt="vim"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:90
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="46" size="1" readonly />
 </form>
 <br><br>------------------------------------------------------------------------------------<br><br>
  <b style="margin-left: 90px"> EXO </b><br><br>
  <img src="image/exo.jpeg" width="300" height="250" alt="exo"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:45
 qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="43" size="1" readonly />
 </form>
<br><br>------------------------------------------------------------------------------------<br><br>
   <b style="margin-left: 90px"> PRIL</b><br><br>
   <img src="image/pril.jpg" width="300" height="500" alt="pril"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:55
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="44" size="1" readonly />
 </form>
 </div></center>
