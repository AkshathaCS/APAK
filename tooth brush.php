...
<center>     <div id="section" style="word-spacing: 50px;font-size: x-large">
             <center><H1 STYLE="font-size: 50px"><u>TOOTH-BRUSH</u></H1></center>
    <br><br>
 
    <b style="margin-left: 90px">COLGATE </b><br><br>
    <img src="image/colgate.jpg" width="300" height="400" alt="colgate"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:25
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="63" size="1" readonly />
 </form>
<br><br>------------------------------------------------------------------------------------<br><br>
   <b style="margin-left: 90px">ORAL-B</b><br><br>
   <img src="image/oral-b.jpg" width="300" height="400" alt="oral-b"/><br><br>
  <form  action="cart_entry.php" method="post"> 
 price:32
qty:<input type="number" name="qty" required/>
 <input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="64" size="1" readonly />
 </form>
    </div></center>
