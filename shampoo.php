...
<center>     <div id="section" style="word-spacing: 50px;font-size: x-large">
             <center><H1 STYLE="font-size: 50px"><u>SHAMPOOS</u></H1></center>
    <br><br>

         <b style="margin-left: 90px;">HIMALAYA</b>  <br><br>
         <img src="image/himalaya.jpeg" width="250" height="400" alt="himalaya"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:220
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="48" size="1" readonly />
 </form>

 <br><br>------------------------------------------------------------------------------------<br><br>
         
          <b style="margin-left: 90px">DOVE</b>  <br><br>
          <img src="image/dove.jpg" width="200" height="400" alt="dove"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:155
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="47" size="1" readonly />
 </form>
 <br><br>------------------------------------------------------------------------------------<br><br>
  <b style="margin-left: 90px"> SUNSILK</b> <br><br>
  <img src="image/sunsilk.jpg" width="300" height="500" alt="sunsilk"/><br><br>
 <form  action="cart_entry.php" method="post">  
 price:105
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="50" size="1" readonly />
 </form>
<br><br>------------------------------------------------------------------------------------<br><br>
   <b style="margin-left: 90px"> HEAD&SHOULDERS</b><br><br>
   <img src="image/head n shoulder.jpg" width="250" height="500" alt="head_and_shoulder"/><br><br>
  <form  action="cart_entry.php" method="post"> 
 price:135
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="49" size="1" readonly />
 </form>
 </div></center>
