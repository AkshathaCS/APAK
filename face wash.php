...
<center>     <div id="section" style="word-spacing: 50px;font-size: x-large">
             <center><H1 STYLE="font-size: 50px"><u>FACE-WASH</u></H1></center>
    <br><br>

         <b style="margin-left: 90px;">HIMALAYA</b>  <br><br>
         <img src="image/himalaya.png" width="300" height="400" alt="himalaya"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:120
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="41" size="1" readonly />
 </form>

 <br><br>------------------------------------------------------------------------------------<br><br>
         
          <b style="margin-left: 90px">PONDS</b>  <br><br>
          <img src="image/ponds.jpg" width="300" height="400" alt="ponds"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:75
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="42" size="1" readonly />
 </form>
 <br><br>------------------------------------------------------------------------------------<br><br>
  <b style="margin-left: 90px"> DOVE</b> <br><br>
  <img src="image/dove.jpeg" width="300" height="400" alt="dove"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:90
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="39" size="1" readonly />
 </form>
<br><br>------------------------------------------------------------------------------------<br><br>
   <b style="margin-left: 90px"> PEARS</b><br><br>
   <img src="image/pears.jpg" width="300" height="400" alt="pears"/><br><br>
   <form  action="cart_entry.php" method="post">
 price:90
qty:<input type="number" name="qty" required/> 
<input type="submit" value="Add to cart" /><br>
item_id:<input type="text" name="item_id" value="40" size="1" readonly />
 </form>
